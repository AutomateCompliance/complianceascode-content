###############################################################################
#
# Bash remediation role for profile rhvh-vpp
# Profile Title:  VPP - Protection Profile for Virtualization v. 1.0 for Red Hat Virtualization Host (RHVH)
# Profile Description:
...
# 	$ oscap xccdf generate fix --profile rhvh-vpp --template urn:xccdf:fix:script:sh sds.xml 
#
