###############################################################################
#
# Bash remediation role for profile amq-stig
# Profile Title:  STIG for Apache ActiveMQ
# Profile Description:
...
# 	$ oscap xccdf generate fix --profile amq-stig --template urn:xccdf:fix:script:sh sds.xml 
#
