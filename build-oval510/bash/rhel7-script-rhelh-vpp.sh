...
# Profile Title:  VPP - Protection Profile for Virtualization v. 1.0 for Red Hat Virtualization
# Profile Description:
...
# 	$ oscap xccdf generate fix --profile rhelh-vpp --template urn:xccdf:fix:script:sh sds.xml 
#
