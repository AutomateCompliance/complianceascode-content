###############################################################################
#
# Bash remediation role for profile draft_stig_wrlinux_disa
...
# 	$ oscap xccdf generate fix --profile draft_stig_wrlinux_disa --template urn:xccdf:fix:script:sh sds.xml 
#
