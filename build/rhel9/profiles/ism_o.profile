description: "This profile contains configuration checks for Red Hat Enterprise Linux\
    ...
    \ risk-based approach to cyber security. This profile provides a guide to aligning\
    \ \nRed Hat Enterprise Linux security controls with the ISM, which can be used\
    \ to select controls \nspecific to an organisation's security posture and risk\
